...
Biggest Data: <a href="/{{coremod}}/{{data[0].Biggest.name}}">{{data[0].Biggest.name}}</a> - 0x{{'%06X'|format(data[0].Biggest.size)}} bytes
Biggest Routine: <a href="/{{coremod}}/{{data[0].Biggest_Routine.name}}">{{data[0].Biggest_Routine.name}}</a> - 0x{{'%04X'|format(data[0].Biggest_Routine.size)}} bytes
