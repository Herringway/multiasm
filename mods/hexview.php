...
class hexview {
	...
	public function execute() {
		...
		$data = rom::get()->read_bytes($this->main->addresses[$this->main->offset]['size']);
		...
		if (isset($this->main->addresses[$this->main->offset]['charset']))
			$charset = Main::get()->game['texttables'][$this->addresses[$this->offset]['charset']]['replacements'];
		...
		return array(array('charset' => $charset, 'width' => isset($this->main->addresses[$this->main->offset]['width']) ? $this->main->addresses[$this->main->offset]['width'] : 16),$data);
